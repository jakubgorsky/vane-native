...
class Message_Formatter:
    ...
    def _get_timestamp(self, current_log_count=None):
        ...
        `current_log_count` is passed from the Logger instance if 'log_number' or 'verbose' is used.
        """
        ...
        if self.timestamp_type in ["datetime", "dt", 1]:
            ...
            # Use the count provided by Logger, or fall back to internal if not provided
    ...
    def format_message(self, level_str, include_timestamp=True, include_level_name=True,
        ...
        `current_log_count` is passed from the Logger instance for 'log_number' and 'verbose' timestamps.
        """
        final_parts = []
